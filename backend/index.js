...
const privateKeyPath = path.join(__dirname, 'abels-key.pem');
const certificatePath = path.join(__dirname, 'abels-csr.pem');
...
resources required to build the user interface and functionality of a website or web application. They are often stored in specific directories (such as /public or /static) within the project's file structure to distinguish them from server-side code files.*/
